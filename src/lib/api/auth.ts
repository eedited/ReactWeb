...
export type signupFunctionType = ({ userId, password, email, nickname }: signupProp) => Promise<AxiosResponse<authReturnProp>>;
export const signup: signupFunctionType = ({ userId, password, email, nickname }: signupProp) => client.post('/auth/signup', {
    userId,
    password,
    email,
    nickname,
