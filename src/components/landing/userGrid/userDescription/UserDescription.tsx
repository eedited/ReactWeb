...
const UserDescription: React.FC<Props> = ({ userInfo }: Props) => (
    <div className="user__description">
        <div className="user__description__title">
            <Link to={`/profile?userId=${userInfo.nickname}`} className="user__description__title__link">{userInfo.nickname}</Link>
        </div>
        <div className="user__description__second">
            <div className="user__description__detail">
                <Link to={`/profile?userId=${userInfo.nickname}`} className="user__description__detail__link">{userInfo.description}</Link>
            </div>
